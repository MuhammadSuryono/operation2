<!-- **********************************************************************************************************************************************************
    ...
    <section id="main-content">
      <section class="wrapper site-min-height">
        <h3><i class="fa fa-angle-right"></i> Soal Equest Skenario <?= $skenario['nama_skenario']?></h3>
        <div class="row mt">
            <form action="<?= base_url('equestisi/simpanisi')?>" method="post">
                ...
                <input type="hidden" name="id_skenario" id="id_skenario" value="<?=$id_skenario?>">
                <input type="hidden" name="id_aktual" id="id_aktual" value="<?=$id_aktual?>">
                <input type="hidden" name="kode_cabang" id="kode_cabang" value="<?=$kode_cabang?>">
                <input type="hidden" name="id_kunjungan" id="id_kunjungan" value="<?=$id_kunjungan['id_kunjungan']?>">
            ...
            <div class="row">
                ...
                <div class="col-lg-10">
                    <div class="form-panel">
                        ...
                        <div style="text-align:center;">
                                <a href="<?= base_url('equestisi')?>" class="btn btn-round btn-danger">Batal</a>
