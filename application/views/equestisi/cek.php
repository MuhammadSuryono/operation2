            ...
            <div class="form-panel">
                ...
                <table class=" table table-bordered table-striped table-condensed table-responsive-sm" id="dataTables-example">
                  ...
                  <tbody>
                      ...
                      <?php 
                            $skenario = $db['id_pembuat_equest'];
                            $nama_skenario = $this->db->query("SELECT a.nama_skenario from data_skenario a join data_pembuat_equest b on a.id_skenario=b.id_skenario where b.id_pembuat_equest = $skenario")->row_array();
                       ?>
                      <?php if($no%2==0):?>
                         ...
                         <?php endif?>
                            ...
                            <td><?= $nama_skenario['nama_skenario']?></td>
                            <td><?= $db['id_kunjungan']?></td>
