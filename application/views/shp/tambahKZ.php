...
<?php elseif($db['kunjungan']=='063' or $db['kunjungan']=='070'): ?>
<?php $no++;?>
<input type="hidden" name="skenario<?=$no?>" id="skenario<?=$no?>" value="<?=$db['kunjungan']?>">
<input type="hidden" name="number<?=$no?>" id="number<?=$no?>" value="<?=$db['num']?>">
...
<?php if($db['kunjungan']=='038' OR $db['kunjungan']=='039' OR $db['kunjungan']=='081' OR $db['kunjungan']=='012' OR $db['kunjungan']=='105' OR $db['kunjungan']=='100' OR $db['kunjungan']=='101' ):?>
...
<!-- =====================================================filter untuk bukti transaksi=================================================== -->
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-3 mb">
                                ...
                                <span class="label label-info"  style="margin-top : 2rem;">NOTE!</span>
                                <span>Format Gambar Bukti Transaksi(.jpg, .jpeg, .png)
                                </span>
                            </div>
                            ...
                            <div class="col-sm-3 mb">
                                ...
                                <span class="label label-info"  style="margin-top : 2rem;">NOTE!</span>
                                <span>Format Gambar Slip Transaksi(.jpg, .jpeg, .png)
                                </span>
                            </div>
                            <?php endif?>
