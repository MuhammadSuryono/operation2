          ...
          <div class="col-lg-12">
            <div class="form-panel">
                ...
                <div class="pull-right">
                  <input type="text" class="form-control" id="caridata" name="caridata" placeholder="Cari Data .." onkeyup='searchTable()'>
                </div>
             ...
             <h5 style="margin-left:2rem; ">Jumlah Data Project : <strong><?= $jumlah_data?><strong></h5>
           </div>
           </div>
