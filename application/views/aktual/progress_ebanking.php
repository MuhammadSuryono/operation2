...
?>
    ...
    <section id="main-content">
      <section class="wrapper site-min-height">
        <h3><i class="fa fa-angle-right"></i> Progress E-Banking </h3>
        <div class="row mt">
          <div class="col-lg-12">
          ...
          <div class="row">
            <div class="col-lg-12">
                <div class="form-panel">
                    <h4 class="mb text-primary"><strong> <i class="fa fa-angle-right"></i> Progress E-Banking </strong> </h4>
                       <!-- Nav tabs -->
                        ...
                        <div class="container-fluid">
                          <section id="unseen">
                            ...
                            <div class="row">
                              ...
                              <div class="col-md-2">
                                <select class="form-control" id="progress_project">
                               ...
                               <div class="col-md-2">
                                <select class="form-control" id="progress_channel">
                               ...
                               <div class="col-md-2">
                                <select class="form-control" id="progress_transaksi">
                              ...
                              <div class="col-md-1">
                                <button type="button" class="btn btn-primary" id="show_progress">Show</button>
                              </div>
