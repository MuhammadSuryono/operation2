        ...
        <div class="row mt">
          ...
          <div class="col-lg-12">
            <div class="form-panel">
                ...
                <div class="col-md-2">
                <button type="button" id ="tampilkanvalidasidata" class="btn btn-round btn-primary pull-left" style="margin-right:0.5rem;"><i class="fa fa-eye fa-fw"></i> Tampilkan </button>
                </div>
