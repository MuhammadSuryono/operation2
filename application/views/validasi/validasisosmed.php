...
<section id="main-content">
      <section class="wrapper site-min-height">
        <h3><i class="fa fa-angle-right"></i> Validasi Data Evaluasi Sosial Media</h3>
        ...
        <div class="row mt">
          ...
          <div class="col-lg-12">
            <div class="form-panel">
                ...
                <div class="row mb">
                <div class="col-md-2">
                    <select class="selectpicker form-control" name="validasi_project" id="validasi2_project" data-live-search="true">
                ...
                <div class="col-md-2">
                    <select class="form-control" name="validasi_bank" id="validasi2_bank" >
                ...
                <div class="col-md-2">
                     <select class="selectpicker form-control" name="validasi_platform" id="validasi_platform" data-live-search="true">
                ...
                <div class="col-md-2" id="div_validasi_skenario">
                  <input type="hidden" name="validasi_skenario" id="validasi_skenario" value="">
                ...
                <div class="col-md-2">
                <button type="button" id ="tampilkanval_sosmed" class="btn btn-round btn-primary pull-left" style="margin-right:0.5rem;"><i class="fa fa-eye fa-fw"></i> Tampilkan </button>
                </div>
