                  ...
                  <tbody>
                      ...
                      <?php if($no%2!=0):?>
                         ...
                         <?php endif?>
                            ...
                            <td><?= $db['tanggal']?></td>
                            <td>
                                <a href="<?= base_url('equestbaru/buat/')?><?= $db['id_pembuat_equest']?>" class="btn btn-success btn-round btn-xs" style="margin-right : 0.5rem;"><span class="fa fa-edit fa-fw"></span>Edit</a>

                                <a href="<?= base_url('equestbaru/lihat/')?><?= $db['id_skenario']?>" class="btn btn-info btn-round btn-xs" style="margin-right : 0.5rem;"><span class="fa fa-edit fa-fw"></span>Lihat</a>
