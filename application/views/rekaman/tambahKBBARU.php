            ...
            <div class="form-panel">
                ...
                <div class="row">
                    <div class="col-md-12">
                            ...
                            <?php $no=0; $atmcenter = array('064','065','066','067'); foreach($quest as $db):
                            $no++; ?>
                            <?php if (in_array($db['kunjungan'], $atmcenter)){
                              echo '<textarea name="formnya'.$no.'" style="display:none;">'.$db['form'].'</textarea>';
                            } ?>
                            <div class="form-group">
                            ...
                            <div class="col-sm-12"><center>
                                ...
                                <span class="fileupload-exists"><i class="fa fa-undo"></i> Ubah</span>
                                    <input onchange="cekPhoto(this.value, `berkas<?=$no?>`)" type="file" class="default" name="berkas<?=$no?>" id="berkas<?=$no?>" accept="image/*" required>
                                </span>
                                </span>
                                ...
                                <span>Format Berkas Wajib Gambar (.jpg/.jpeg/.png/.gif)
                                </span>
                            </div>
                            <center></div>
                            <?php endforeach?>
                            <input type="hidden" name="jumlahsek" id="jumlahsek" value="<?=$no?>">
                            <button type="submit" id="simpanrekaman" class="btn btn-round btn-primary pull-right"><i class="fa fa-check-circle fa-fw"></i> Simpan</button>
