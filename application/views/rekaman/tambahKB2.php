<section id="main-content">
      <section class="wrapper site-min-height">
        <h3><i class="fa fa-angle-right"></i> Form Upload Ulang Rekaman </h3>
        <div class="row mt">
          <div class="col-lg-12">
          ...
          <div class="col-lg-12">
            <div class="form-panel">
                ...
                <div class="col-md-6">
<form class="form-horizontal style-form" method="POST" action="<?php echo base_url('rekaman/updatedatarekaman') ?>"  enctype="multipart/form-data">
                    ...
                    <div class="col-md-12">
                            ...
                            <div class="col-sm-12"><center>
                                ...
                                <span class="fileupload-exists"><i class="fa fa-undo"></i> Ubah</span>
                                    ...
                                    <!-- <input  type="file" class="default" name="berkas" id="berkas<?=$no?>" accept="image/*" required> -->
                                </span>
                                </span>
                                ...
                                <span>Format Berkas Wajib Gambar (.jpeg/.jpg/.png/.gif)</span>
                            </div>
                            <center></div>
                            <?php endforeach?>
