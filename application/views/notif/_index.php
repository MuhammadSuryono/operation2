...
<section id="main-content">
      <section class="wrapper site-min-height">
        ...
        <div class="row mt">
          ...
          <div class="row">
            <?php 
              if ($email_user == NULL AND $id_divisi != 'Ebanking') {
                ?>
         ...
         <div class="row">
              ...
              <div class="form-panel">
                ...
                <?php 
                 ...
                 $budget = $dbbudget->get_where('pengajuan', array('kodeproject' => $n_pro['kode']))->result_array(); 
                  if ($budget == NULL) {
                  ?>
                  <a type="button" class="btn btn-warning btn-sm"  > Budget Online</a>
                <?php } 
                if ($plan != NULL AND $cabang != NULL AND $skenario != NULL AND $oneproject != NULL AND $budget != NULL) {
                  continue;
                }
          ...
          <?php } ?>
              ...
              <div class="col-lg-12">
                ...
                <?php $no=1; foreach($notif99e1 as $nf99e1):?>
              ...
              <div class="form-panel">
                ...
                <?php foreach($notif4 as $nf4):?>
                  <a style="color:#1c1c1f; font-size:1.4rem;"><span class="badge bg-warning mr"><?=$no++?></span> Screnshot Equest Untuk Project
                ...
                <?php foreach($notif5 as $nf5):?>
                  <a style="color:#1c1c1f; font-size:1.4rem;"><span class="badge bg-warning mr"><?=$no++?></span> Slip Transaksi Untuk Project
            ...
            <div class="row">
              ...
              <div class="form-panel">
                ...
                <?php if ($this->session->userdata('id_divisi') != 4){ ?>
                  ...
                  <a type="button" class="btn btn-info btn-xs btn-round" href="<?=base_url('aktual/file_ebanking/'.$n_eb['num'])?>" target="_blank"> Upload Ulang File</a>
                <?php } ?>
                  <br><br>
                <?php endforeach?>
