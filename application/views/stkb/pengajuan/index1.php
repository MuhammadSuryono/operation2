      ...
      <section class="wrapper site-min-height">
        ...
        <div class="row mt">
          ...
          <div class="row">
            ...
            <section id="unseen">
              ...
              <ul class="nav nav-tabs">
                ...
                <li><a data-toggle="tab" href="#term23">Cek Pengajuan Term 2 & Term 3</a></li>
          ...
          <div class="tab-content">
                ...
                <table class=" table table-bordered table-striped table-condensed">
                  ...
                  <tbody>
                      <?php
                       ...
                       //  $query = $koneksi->query("SELECT 100 * COUNT(nomorstkb)
                       //                            /
                       //                            (
                       //                            SELECT
                       //                              COUNT(b.att)
                       ...
                       // if($progressnya < 50){
                         ...
                         <tr>
                          ...
                          <td><?php echo 'Rp. ' . number_format( $key['perdin'], 0 , '' , ',' ); ?><input type="hidden" name="perdin" value="<?php echo $key['perdin']?>"></td>
                          <td><?php echo 'Rp. ' . number_format( $key['akomodasi'], 0 , '' , ',' ); ?><input type="hidden" name="akomodasi" value="<?php echo $key['akomodasi']?>"></td>
                          <td><?php echo 'Rp. ' . number_format( $key['bpjs'], 0 , '' , ',' ); ?><input type="hidden" name="bpjs" value="<?php echo $key['bpjs']?>"></td>
                       ...
                       <?php
                       // }
                       // else if($progressnya >= 50 && $progressnya < 100){
                       //   $totalnya = $key['jumlahops'] + $key['jumlahtrk'];
                       ?>
                         <!-- <tr> -->
                          <!-- <td><?php //echo $no; ?></td>
                          <td><?php //echo $key['nmrstkb'] ?><input type="hidden" name="nomorstkb<?php //echo $key['nmrstkb'] ?>" value="<?php //echo $key['nmrstkb'] ?>"></td>
                          ...
                          <td><?php //echo $key['kodeproject'] ?> - <?php //echo $key['namaproject'] ?><input type="hidden" name="kodeproject<?php //echo $key['nmrstkb'] ?>" value="<?php //echo $key['kodeproject'] ?>"></td>
                          <td><?php //echo $key['idpic'] ?> - <?php //echo $key['namapic'] ?><input type="hidden" name="idpic<?php //echo $key['nmrstkb'] ?>" value="<?php //echo $key['idpic'] ?>"></td>
                          <td><?php //echo 'Rp. ' . number_format( $key['perdin'], 0 , '' , ',' ); ?><input type="hidden" name="perdin" value="0"></td>
                          <td><?php //echo 'Rp. ' . number_format( $key['akomodasi'], 0 , '' , ',' ); ?><input type="hidden" name="akomodasi" value="0"></td>
                          <td><?php //echo 'Rp. ' . number_format( $key['bpjs'], 0 , '' , ',' ); ?><input type="hidden" name="bpjs" value="0"></td>
                          <td><?php //echo $key['jumlahops'] ?><input type="hidden" name="jumlahops<?php //echo $key['nmrstkb'] ?>" value="<?php //echo $key['jumlahops'] ?>"></td>
                          <td><?php //echo $key['jumlahtrk'] ?><input type="hidden" name="jumlahtrk<?php //echo $key['nmrstkb'] ?>" value="<?php //echo $key['jumlahtrk'] ?>"></td>
                          <td><?php //echo $totalnya; ?><input type="hidden" name="total<?php //echo $key['nmrstkb'] ?>" value="<?php //echo $totalnya; ?>"></td>
                          <td><input type="checkbox" style="width: 30px" class="checkbox form-control" id="agree" name="statusbayar[]" value="<?php //echo $key['nmrstkb'] ?>" /></td>
                          <td><a href="<?php //echo base_url(); ?>stkb/printstkb/<?php //echo $key['nmrstkb']; ?>/<?php //echo $key['termnya']; ?>" target="_blank"><i class="fa fa-print"></i> Print</a></td> -->
                       <?php
                       // }
              ...
              <div id="term23" class="tab-pane fade">
                <div class="table-responsive">
                <form action="<?php echo base_url('stkb/readytopaid')?>" method="POST" enctype="multipart/form-data">
                <input type="hidden" name="pengklik" value="<?php echo $this->session->userdata('id_user'); ?>">
                <table class=" table table-bordered table-striped table-condensed">
                  ...
                  <tbody>
                      <?php
                        $no = 1;
                        $totalterm23 = 0;
                        foreach ($allpengajuanterm as $keyy) :
                       ...
                       ?>
                         <tr>
                          ...
                          <td><?php echo 'Rp. ' . number_format( $keyy['perdin'], 0 , '' , ',' ); ?><input type="hidden" name="perdin" value="0"></td>
                          <td><?php echo 'Rp. ' . number_format( $keyy['akomodasi'], 0 , '' , ',' ); ?><input type="hidden" name="akomodasi" value="0"></td>
                          <td><?php echo 'Rp. ' . number_format( $keyy['bpjs'], 0 , '' , ',' ); ?><input type="hidden" name="bpjs" value="0"></td>
