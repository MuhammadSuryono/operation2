      ...
      <section class="wrapper site-min-height">
        ...
        <div class="row mt">
          ...
          <div class="tab-content">
                      ...
                      <?php
                       ...
                       ?>
                         <tr>
                          ...
                          <td><input type="checkbox" style="width: 30px" class="checkbox form-control" id="agree2" name="statusbayar[]" value="<?php echo $keyy['nmrstkb'] ?>" /></td>
		    ...
		    <?php if ($user['id_divisi'] == 7 or $user['id_divisi'] == 99) :?>
                    <div class="col-md-1 text-center">
                      <!-- <center><input type="checkbox" style="width: 30px" class="checkbox form-control" onclick="checkall2()" id="checkAll2" disabled /></center>
