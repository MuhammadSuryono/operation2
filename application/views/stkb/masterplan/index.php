              ...
              <div class="row">
                ...
                <div class="col-sm-8">
                  ...
                  <div id="ajukanNamaLain" class="form-group" style="display:none;">
                    <label><b>Nama :</b></label><a href="javascript;" data-toggle="modal" data-target="#pengajuanLintasPulau" class="btn btn-primary" style="font-size:10px;float:right;">Ajukan Nama Lain</a>
                    <select class="form-control selectpicker" data-live-search="true" name="pic" id="namapic" required>
