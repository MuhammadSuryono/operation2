        ...
        <div class="row mt">
          ...
          <div class="col-lg-12">
            <div class="form-panel">
                <h4 class="mb text-primary"> <strong> <i class="fa fa-angle-right"></i> Daftar Data Validasi New</strong></h4>
                      ...
                      <?php if($no%2==0):?>
                         ...
                         <?php endif?>
                            ...
                            <?php if($this->db->get_where('summary_2', ['shp_id'=>$db['shp'],'project_kode'=>$db['project'],'cabang_kode'=>$db['cabang'],'kunjungan_kode'=>$db['r_kategori'],'sub_kunjungan_kode'=>$db['kunjungan']])->num_rows()>=1 or $this->db->get_where('data_rekaman', ['id_user'=>$db['shp'], 'id_project'=>$db['project'], 'kode_cabang'=>$db['cabang'],'kunjungan'=>$db['r_kategori'],'id_skenario'=>$db['kunjungan']])->num_rows()>=1) : ?>
                                <a href="<?= base_url('validasi/lihatdata/')?><?= $db['num']?>" class="btn btn-info btn-round btn-xs" style="margin-right : 0.5rem;"><span class="fa fa-warning fa-fw"></span> Lihat </a>
                            <?php endif?>
                            </td>
                        </tr>
                      <?php endforeach?>
