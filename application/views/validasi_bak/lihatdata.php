    ...
    <section id="main-content">
      <section class="wrapper site-min-height">
        ...
        <!-- AWAL ROW -->
            <div class="col-lg-12">
              <!-- PUNYA IWAY -->
                <div class="row" id="headerrekaman"  style="z-index:1;width: 82.3%;">
                  <div class="col-lg-12">
                    <div class="form-panel">
                    ...
                    <div class="col-lg-12">
                        <div class="form-panel">
                            ...
                            <section id="jmlpiltd"></section>
                              ...
                              <!-- <button onclick="window.location.href = 'http://192.168.15.101:3000/video/<?=$rekaman['file_rekaman']?>';">Download Rekaman</button> -->

                              <!-- <audio controls id="rekaman"> 
                                    <source src="http://192.168.15.101:3000/video/1.mp3" type="audio/mp3">
                              </audio> -->
