          ...
          <div class="row">
            <div class="col-lg-12">
                <div class="form-panel">
                    <form action="<?=base_url('validasi/validasidatanew')?>" class="form-horizontal style-form" method="post">
                      <input type="hidden"  name="sproject" id="sproject" value="<?=$db['project_kode']?>">
                      <input type="hidden"  name="skunjungan" id="skunjungan" value="<?=$db['kunjungan_kode']?>">
                      <button type="submit" class="btn btn-primary pull-right" style="margin-right:0.5rem;"><i class="fa fa-arrow-left fa-fw"></i> BACK </button>
                    </form>
                    ...
                    <thead>
                        ...
                        <th class="dialog" style="background-color:#9c9795;color:white;">Dialog</th>
                        <?php elseif($db['r_sts_dialog']=='0') :?>
                        <th class="dialog" style="background-color:#dc3545;color:white;">Dialog</th>
                        <?php else :?>
                        <th class="dialog" style="background-color:#22b540;color:white;">Dialog</th>
                        <?php endif?>

                        <?php if($sts_quest['rekaman_status']=='0'):?>
                        <th class="rekaman"  style="background-color:#9c9795;color:white;">Rekaman</th>
                        <?php elseif($sts_quest['rekaman_status']=='1') :?>
                        <th class="rekaman" style="background-color:#dc3545;color:white;">Rekaman</th>
                        <?php else :?>
                        <th class="rekaman" style="background-color:#22b540;color:white;">Rekaman</th>
                        <?php endif?>

                        <?php if($db['r_sts_upload_layout']==null):?>
                        <th class="layout" style="background-color:#9c9795;color:white;;">Layout</th>
                        <?php elseif($db['r_sts_upload_layout']=='0') :?>
                        <th class="layout" style="background-color:#dc3545;color:white;">Layout</th>
                        <?php else :?>
                        <th class="layout" style="background-color:#22b540;color:white;">Layout</th>
                        <?php endif?>

                        <?php if($db['r_sts_upload_ss']==null):?>
                        <th class="ss" style="background-color:#9c9795;color:white;">Screenshot</th>
                        <?php elseif($db['r_sts_upload_ss']=='0') :?>
                        <th class="ss" style="background-color:#dc3545;color:white;">Screenshot</th>
                        <?php else :?>
                        <th class="ss" style="background-color:#22b540;color:white;">Screenshot</th>
                        <?php endif?>

                        <?php if($db['r_sts_upload_slip_transaksi']==null):?>
                        <th class="transaksi" style="background-color:#9c9795;color:white;">Slip Transaksi</th>
                        <?php elseif($db['r_sts_upload_slip_transaksi']=='0') :?>
                        <th class="transaksi" style="background-color:#dc3545;color:white;">Slip Transaksi</th>
                        <?php else :?>
                        <th class="transaksi" style="background-color:#22b540;color:white;">Slip Transaksi</th>
                        <?php endif?>
                        </tr>
                    </thead>
                    <tbody>
                            <tr style="background-color : #e2e4ff;">
                                ...
                                <td><a class="fancybox" href="<?= base_url('assets/')?>file/buktitrk/<?=$db['upload_layout']?>"><?= $db['upload_layout']?></a><br>
                                ...
                                <td><a class="fancybox" href="<?= base_url('assets/')?>file/buktitrk/<?=$db['upload_ss']?>"><?= $db['upload_ss']?></a><br>
                                ...
                                <td><a class="fancybox" href="<?= base_url('assets/')?>file/buktitrk/<?=$db['upload_slip_transaksi']?>"><?= $db['upload_slip_transaksi']?></a><br>
          ...
          <div class="row">
            <div class="col-lg-6" >
                <div class="form-panel">
                    ...
                    <?php if($db['r_teks_dialog']==null or $db['r_teks_dialog']==''):?>
                    ...
                    <div class="col-lg-12">
                        <div class="form-panel">
                            ...
                            <!-- <div class="col-lg-3 navbar navbar-inverse" data-spy="affix" data-offset-top="197"> -->
                              <hr>
                              <!-- <audio controls id="rekaman" src="http://192.168.15.101:3000/video/1"></audio> -->
                                <audio controls id="rekaman"> 
                                      <source src="http://192.168.8.101:3000/video/<?=$rekaman['file_rekaman']?>" type="audio/mp3">
                                </audio>
                              <hr>
